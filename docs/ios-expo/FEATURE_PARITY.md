...
| 4.15 | PDF report: export/share/print; free users get "Watch ad" or "Just make it" — both produce the report; PRO sees no ad | `service/MatchingPdfReportService.kt`, `service/RewardedAdManager.kt` | [ ] | [ ] |
| 4.16 | Saved astrology reports | `data/local/SavedReport*` | [ ] | [ ] |
...
| 8.20 | Home-screen widget: Panchang (sunrise, sunset, tithi… localised labels) | `widget/PanchangWidgetProvider.kt`, `res/layout/panchang_widget.xml` | [ ] | [ ] |
